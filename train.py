...
def parse_args():
    ...
    parser.add_argument('--train_path', type=str, default='D:/PhDcareer/event_deblur_dataset/GOPRO_shi/train/', help='train data path')
    parser.add_argument('--val_path', type=str, default='D:/PhDcareer/event_deblur_dataset/GOPRO_shi/test/', help='validation data path')
